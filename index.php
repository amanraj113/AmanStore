...
<div id="main_wrapper">
	<div id="main_header">
    	<div id="site_title"><h1><a href="#" rel="nofollow">Aman Online Store</a></h1></div>
    ...
    <div id="main_middle">
    	...
    	<h1>Aman Web Store</h1>
        <p><a href="#" rel="nofollow" target="_parent">Aman Online Store</a> is a merchandise store that lets you franchise.</p>
    ...
    <div id="main_footer">   
		...
		<center>
			Copyright © 2048 Aman Online Store
		</center>
    </div> <!-- END of footer -->   
